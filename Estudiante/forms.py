...
class FormularioRegistro(forms.ModelForm):
    class Meta:
        ...
        widgets={
            ...
            'documento':forms.TextInput(attrs={'class':'form-control','required': True}),
            ...
            'primer_nombre':forms.TextInput(attrs={'class':'form-control','required': True}),
            'segundo_nombre':forms.TextInput(attrs={'class':'form-control'}),
            'primer_apellido':forms.TextInput(attrs={'class':'form-control','required': True}),
            'segundo_apellido':forms.TextInput(attrs={'class':'form-control','required': True}),
